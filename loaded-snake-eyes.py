...
def snake_eyes():
    global winning_pot
    die_numbers = [1, 1, 1, 1, 1, 3, 4, 5, 6]
    die1 = random.choice(die_numbers)
    die2 = random.choice(die_numbers)
    die3 = die1 + die2
...
### exposition
print("Psssst - hey, you, I got a ummmm... a totally legit game if you fancy a bit of danger?")
